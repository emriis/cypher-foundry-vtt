 ...
 * unique — un bonus de Réserve et une compétence entrainée au choix — que le joueur applique
 * à sa fiche PJ en le glissant dessus. Ce n'est volontairement PAS un item persistant sur
 * l'acteur : comme pour un Type ou un Focus, seul son EFFET (le bonus de Réserve + la
 * Compétence créée) reste sur la fiche, matérialisé par le champ texte system.descriptor
 * du PJ et par l'item Compétence généré (voir CypherActor#applyDescriptor).
 *
