...
description: "Use when implementing, reviewing, or debugging Cypher rules, Foundry VTT V13/V14 system code, or this repository's bilingual compendiums, including data models, documents, character sheets, migrations, content sources, and behavior tests. Pour les demandes en français sur les règles Cypher, le système Foundry, les fiches, les compendiums et leurs sources."
...
- Treat the system as unofficial and preserve Cypher Open License notices and attribution. Do not reproduce substantial CRD text or provide definitive legal advice.
